...
export const SERVICES: Service[] = [
  {
    ...
    name: 'Nextcloud',
    nameKo: '클라우드',
    description: '업무 파일 중앙 관리 · 부서별 공유 폴더 · 협업 캘린더',
  ...
  },
  {
    ...
    name: 'Paperless ngx',
    nameKo: '페이퍼리스',
    description: '세금계산서 · 영수증 · 계약서 디지털 아카이브 — OCR 자동 분류 · 즉시 검색',
  ...
  },
  {
    ...
    name: 'ArchiveBox',
    nameKo: '아카이브 박스',
    description: '거래처 웹페이지 · 정부 지원사업 공고 · 규정 변경 이력을 장기 보존하는 웹 아카이브',
  ...
  },
  {
    ...
    name: 'Learn',
    nameKo: '교육',
    description: '직원 교육 · 자격증 CBT 문제풀이 · 산업안전교육 진도 관리',
    url: '/learn',
    color: '#6366f1',
    bgColor: '#eef2ff',
    bgColorDark: '#1a1a3e',
  ...
  },
  {
    ...
    name: 'On-Demand 서버',
    nameKo: '온디맨드 서비스',
    description: '필요할 때만 가동하는 온디맨드 서비스 — 비업무시간 자동 종료로 비용 절감',
    url: '/servers',
    color: '#4f7fff',
    bgColor: '#ebf0ff',
    bgColorDark: '#0e1533',
  ...
  },
  {
    ...
    nameKo: '코블버스',
    description:
      'Cobblemon 기반 온디맨드 모드팩 서버. 클릭하면 서버 시작·종료 패널로 이동합니다.',
    category: 'Game Server',
    categoryIcon: 'GAME',
